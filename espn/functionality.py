...
def get_heads_up(league, week=None, warning=0):
    ...
    for i in box_scores:
        headsup += scan_roster(i.home_lineup, i.home_team, warning, emotes)
        headsup += scan_roster(i.away_lineup, i.away_team, warning, emotes)
...
def scan_roster(lineup, team, score_warn, emotes):
    count = 0
    players = []
    for i in lineup:
